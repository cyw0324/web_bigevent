$(function() {
    ...
    function renderPage(total) {
        ...
        laypage.render({
            ...
            // ['prev','page','next'] 默认值
            layout: ['count','limit','prev','page','next','skip'], // 顺序由数组顺序决定
            limits: [2,3,5,10],
            ...
            jump: function(obj, first) {
                ...
                // 如果 first 的值为 true, 证明是 方式2 触发的
                // 否则就是 方式1 触发的
                console.log(first)
                console.log(obj.curr)
                // 把最新的页码值，赋值到 q 这个查询参数对象中
                q.pagenum = obj.curr
                // 把最新的条目数，赋值到 q 这个查询参数对象的 pagenum 属性中
                q.pagesize = obj.limit
                // 根据最新的 q 获取对应的数据列表，并渲染表格
                // initTable() 不能直接调用，会发生死循环
                if (!first) {
                    initTable()
                }
            }
